...
% Layout settings
\columnsep=8pt % Space between columns (further reduced to give more room for 4 columns)
...
\newcommand{\twocolimg}[2]{%
	\begin{center}
			\parbox{0.48\textwidth\relax}{% approximate two columns width (2*0.24)
				\centering
	...
	\postersection{Write Performance Results}
					...
					\twocolimg{write_bigload_avgnet_heatmap.png}{Write Response Time Heatmap - Big Load, Average Network}
	...
	\postersection{Performance Threshold Analysis}
					...
					\twocolimg{write_bigload_avgnet_boundary.png}{Performance Boundary Between EC and Replication}
	...
	\postersection{Read Performance Results}
					...
					\twocolimg{read_bigload_avgnet_heatmap.png}{Read Response Time Heatmap - Big Load, Average Network}
	...
	\postersection{Network Conditions Impact}
					...
					\twocolimg{write_bigload_slownet.png}{Performance Under Slow Network Conditions}
