...
\small \textit{Erasure Coding Performance Analysis Against Replication on Distributed Key-Value Store Database} \\
\small \textbf{Muhamad Aji Wibisono (13521095)} \\
\small Program Studi Teknik Informatika, Institut Teknologi Bandung \\
\end{minipage}
\vspace*{-1.6cm} % tighten space between header and body (use * to override page-break glue)
\noindent
...
\vspace{1.2cm} % add bottom margin so content doesn't run to the page edge
\end{multicols}
\end{document}