...
\begin{enumerate}
  ...
  \begin{figure}[ht]
    ...
    \label{fig:write-lgload-avgnet-scatter}
  \end{figure}
  ...
  Model \textit{ridge regression} gabungan dari \textit{bandwidth} dan \textit{payload} terhadap \textit{response time} menghasilkan model tiga dimensi seperti yang ditunjukkan pada gambar \ref{fig:write-lgload-avgnet-regression}.
