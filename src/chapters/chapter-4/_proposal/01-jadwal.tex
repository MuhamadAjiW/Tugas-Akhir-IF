...
Dari aktivitas-aktivitas tersebut, jadwal perencanaan pelaksanaan masing-masing aktivitas dapat dilihat pada Tabel \ref{tab:jadwal-part1} dan Tabel \ref{tab:jadwal-part2}.
