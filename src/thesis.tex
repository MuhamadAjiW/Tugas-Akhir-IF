...
\title{Analisis Response Time Erasure Coding terhadap Replikasi pada Sistem Database Terdistribusi}
% \title{Evaluasi Pemanfaatan Erasure Coding pada Response Time Sistem Database Terdistribusi}
% \title{Evaluasi Response Time Penggunaan Erasure Coding pada Sistem Key-Value Database Terdistribusi}
\date{}
\author{
  \authorname{} \\
  NIM: \authornim{}
